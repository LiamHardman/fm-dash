# FM-Dash Technical Details

This document contains the technical architecture, deployment information, and development setup for FM-Dash. For user-focused information, see the main [README.md](readme.md).
