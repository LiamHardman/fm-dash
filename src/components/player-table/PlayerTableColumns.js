...
export const allFifaStatDefinitions = {
  GK: {
    name: 'GK',
    label: 'GK',
    field: 'gk',
...
/**
 * Creates the current columns configuration based on props
 * @param {Object} props - Component props
 * @returns {Array} Array of column definitions
 */
export function createCurrentColumns(props) {
  const newOrderBase = [
...
/**
 * Gets the column label for a field name
 * @param {Array} currentColumns - Current columns configuration
 * @param {String} fieldName - Field name
 * @returns {String} Column label
 */
export function getColumnLabel(currentColumns, fieldName) {
  const col = currentColumns.find((c) => c.name === fieldName)
