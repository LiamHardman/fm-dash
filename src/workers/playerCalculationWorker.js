...
const positionSortOrder = [
    "GK", "DR", "DL", "DC", "WBR", "WBL", "DM", "MC", "MR", "ML", 
    "AMR", "AMC", "AML", "ST"
];
...
function filterPlayers(players, filters) {
    return players.filter(player => {
        ...
        if (filters.transferValueMin !== null && player.transferValueAmount < filters.transferValueMin) {
            return false;
        }
        if (filters.transferValueMax !== null && player.transferValueAmount > filters.transferValueMax) {
            return false;
        }
